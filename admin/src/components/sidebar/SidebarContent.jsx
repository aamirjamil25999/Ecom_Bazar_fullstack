...
import logoLight from "@/assets/img/logo/day-mode.png";
  ...
  return (
    <div className="py-4 text-gray-500 dark:text-gray-400">
      <a className=" text-gray-900 dark:text-gray-200" href="/dashboard">
        {mode === "dark" ? (
          <img src={logoLight} alt="kachabazar" width="13" className="pl-6" />
        ) : (
          <img src={logoDark} alt="kachabazar" width="13" className="pl-6" />
        )}
      </a>
      <ul className="mt-8">
